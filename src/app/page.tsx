...
export default function Home() {
  ...
  const { isAuthenticated, isLoading, displayName, role, uid } = useAppSelector(
    (state) => state.auth,
  );
    ...
    >
      <Layout style={{ minHeight: "100vh", background: "#0f111a" }}>
        ...
        >
          ...
          >
            Выберите тип звонка, чтобы продолжить. Для приватных разговоров
            используйте «Звонки 1 на 1», для встреч с коллегами или друзьями —
            «Групповые звонки».
          </Text>
        </Content>
      </Layout>
